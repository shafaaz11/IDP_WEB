              ...
              <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="stok" name="stok">
                          <option value="Tersedia" <?php if ($getProduknfo->stok == "Tersedia") echo 'selected="selected"'; ?>>Tersedia</option>
                          <option value="Tidak Tersedia" <?php if ($getProduknfo->stok == "Tidak Tersedia") echo 'selected="selected"'; ?>>Tidak Tersedia</option>
                      </select>
                  </div>
