 ...
 ?>
			...
			<div class="col-lg-6 get_in_touch_col">
				<div class="get_in_touch_contents">
					<h1>Daftar</h1>
					<p>Silahkan Daftar Lengkapi Data Di bawah Ini</p>
					<form method="post" enctype="multipart/form-data">
						...
						<div>
							<button id="review_submit" type="submit" class="red_button message_submit_btn trans_300" name="register" value="Submit" style="background-color: #6777ef;">Register</button>
						</div>
					</form>
				</div>
			</div>
