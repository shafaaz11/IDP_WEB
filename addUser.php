            ...
            ?>
                     <form action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name" value="<?php if(isset($r_name)) { echo $r_name;}?>" placeholder="Enter Your Name" name="name" required/>
                      </div>
	                  <div class="form-group">
                     ...
                     <div class="form-group">
                         <label for="mob">No Wa:</label>
                         <input type="tel" class="form-control" value="<?php if(isset($mob)) { echo $mob;}?>"id="mob" placeholder="Enter Phone Number" name="mobile" required/>
                     </div>
	                 <div class="form-group">
