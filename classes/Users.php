...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
  ...
  <strong>Error !</strong> Email atau Kata Sandi tidak boleh Kosong !</div>';
        ...
        $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Error !</strong> Email tidak ditemukan, gunakan email atau kata sandi yang sudah terdaftar!</div>';
          return $msg;
      }else{
  ...
  <strong>Error !</strong> Kata sandi baru minimal harus 6 karakter !</div>';
    ...
    public function AddProduct($data){
      ...
      // Tentukan nilai stok berdasarkan pilihan pengguna
      $stok = isset($data['stok']) ? $data['stok'] : 'Tidak Tersedia';

      $sql = "INSERT INTO tbl_produk(penjual, notlp, namaproduk, harga, deskripsi, kategori, stok, fldimage) VALUES (:penjual, :notlp, :namaproduk, :harga, :deskripsi, :kategori, :stok, :fldimage)";
      $stmt = $this->db->pdo->prepare($sql);
